        ...
        <div class="container-fluid">
          ...
          <div class="card">
            <div class="card-header">
              ...
              <a href="tambah_petugas.php" class="btn btn-sm btn-primary float-right" <?= $_SESSION['level'] == 'petugas' ? 'hidden' : '' ?>>Tambah Petugas</a>
            </div>
            <!-- /.card-header -->
            <div class="card-body">
              <table id="example1" class="table table-bordered table-striped text-center">
                <thead>
                  <tr>
                    ...
                    <th>Telepon</th>
                    <th>Level</th>
                    <th <?= $_SESSION['level'] == 'petugas' ? 'hidden' : '' ?>>Aksi</th>
                  </tr>
                </thead>
                <tbody>
                  <?php $no = 1;
                  foreach ($db2->tampil_petugas() as $tmpl_data) : ?>
                    <tr>
                      <td><?= $no++ ?></td>
                      <td><?= $tmpl_data['nama_petugas'] ?></td>
                      <td><?= $tmpl_data['username'] ?></td>
                      <td><?= $tmpl_data['telp'] ?></td>
                      <td><?= $tmpl_data['level'] ?></td>
                      <td <?= $_SESSION['level'] == 'petugas' ? 'hidden' : '' ?>>
                        <div class="btn-group btn-group-sm">
                          <a href="edit_petugas.php?id=<?= $tmpl_data['id_petugas'] ?>" class="btn btn-warning">Edit</a>
                          <a href="petugas.php?d-id=<?= $tmpl_data['id_petugas'] ?>" class="btn btn-danger" onclick="return confirm('Yakin hapus petugas?')">Hapus</a>
                        </div>
                      </td>
                    </tr>
                  <?php endforeach; ?>
