...
if (isset($_POST['edit'])) {
  $edit = $db2->edit_petugas($id);
  if ($edit == true) {
    echo "<script>
                alert('Edit petugas berhasil')
                window.location.href = 'petugas.php'
            </script>";
  } else {
    echo "<script>
                alert('Edit petugas gagal')
            </script>";
  }
}
            ...
            <form action="" method="POST">
              <div class="card-body">
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" id="nama" placeholder="Nama Petugas" name="nama_petugas" value="<?= $data['nama_petugas'] ?>">
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                  ...
                  <input type="password" class="form-control" id="password" placeholder="Password" name="password_baru">
                </div>
                <div class="form-group">
                  <label for="telepon">Telepon</label>
                  <input type="number" class="form-control" id="telepon" placeholder="Telepon" name="telp" value="<?= $data['telp'] ?>">
                </div>
                <div class="form-group">
                  <label>Level</label>
