...
if (isset($_GET['d-id'])) {
    $id = $_GET['d-id'];
    $del = $db3->hapus_pengaduan($id);
    if ($del == true) {
        echo "<script>
                alert('Hapus pengaduan berhasil')
                window.location.href = 'pengaduan.php'
            </script>";
    } else {
        echo "<script>
                alert('Hapus pengaduan gagal')
                window.location.href = 'pengaduan.php'
            </script>";
    }
}
                ...
                <div class="container-fluid">
                    ...
                    <div class="card">
                        <div class="card-header">
                            ...
                            <a href="tambah_pengaduan.php" class="btn btn-sm btn-primary float-right">Buat Pengaduan</a>
                        </div>
                        <!-- /.card-header -->
                        <div class="card-body">
                            <table id="example1" class="table table-bordered table-striped text-center">
                                ...
                                <tbody>
                                    <?php $no = 1;
                                    foreach ($db2->tampil_pengaduan() as $tmpl_data) : ?>
                                        <tr>
                                            <td><?= $no++ ?></td>
                                            <td><?= date('d M Y', strtotime($tmpl_data['tgl_pengaduan'])) ?></td>
                                            <td><?= $tmpl_data['isi_laporan'] ?></td>
                                            <td>
                                                <img src="../../assets/gambar/<?= $tmpl_data['foto'] ?>" width="100px">
                                            </td>
                                            <td>
                                                <?php if ($tmpl_data['status'] == 'proses') { ?>
                                            ...
                                            <td>
                                                <div class="btn-group btn-group-sm">
                                                    <a href="pengaduan.php?d-id=<?= $tmpl_data['id_pengaduan'] ?>" class="btn btn-danger" onclick="return confirm('Yakin hapus pengaduan?')">Hapus</a>
                                                </div>
                                            </td>
                                        </tr>
                                    <?php endforeach; ?>
